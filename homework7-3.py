...
class Cell:
    ...
    def __str__(self):
        return f"Количество ячеек равно {self.count}."
    def __add__(self, other):
        return f"{Cell(self.count + other.count)} при операции сложения."
    def __sub__(self, other):
        if self.count - other.count > 0:
            return f"{Cell(self.count - other.count)} при операции вычитания."
        else:
            return "Значение меньше или равно 0."
    def __mul__(self, other):
        return f"{Cell(self.count * other.count)} при операции умножения."
    def __truediv__(self, other):
        return f"{Cell(self.count // other.count)} при операции целочисленного деления."
